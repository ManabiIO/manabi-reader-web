...
The EPUB reader includes code and ideas derived from [Foliate.js](https://github.com/johnfactotum/foliate-js), including the fully HAS stuff. Foliate.js is MIT-licensed; its notice is retained in [third-party EPUB licenses](https://github.com/ManabiIO/manabi-reader-web/blob/main/THIRD_PARTY_EPUB_LICENSES.md).
