...
test('not-ready and nonfinite measurements cannot overwrite a saved bookmark', () => {
  for (const [count, total] of [[-1,4410], [NaN,4], [4,NaN], [Infinity,4], [1,0], [4,3], [0,-1]]) {
...
test('an empty or illustration-only book has a finite zero progress', () => {
