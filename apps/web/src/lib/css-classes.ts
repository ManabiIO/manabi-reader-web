...
export const baseHeaderClasses = 'app-header relative h-12 bg-surface-raised text-ink xl:h-10';
...
export const inputClasses =
  'mt-1 block w-full px-0.5 bg-background-color border-0 border-b-2 border-line focus:ring-0 focus:border-accent transition';
export const buttonClasses =
  'inline-block no-underline font-medium rounded min-w-[32px] sm:min-w-[64px] px-4 leading-9 cursor-pointer text-accent';
